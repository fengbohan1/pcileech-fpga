...
set files [list \
 [file normalize "${origin_dir}/ip/FC1004_RGMII.edn"]\
 [file normalize "${origin_dir}/ip/FC1004_RGMII.vh"]\
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
